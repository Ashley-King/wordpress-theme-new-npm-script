 ...
 * INITIAL STYLES
 *********************************************/
	wp_enqueue_style( 'styles', get_template_directory_uri() . '/assets/css/style.min.css',false, null ,'all');
 ...
 * CUSTOM JS
 *********************************************/
  wp_enqueue_script('custom-scripts', get_template_directory_uri() . '/assets/js/bundle.min.js', null, null, true);
